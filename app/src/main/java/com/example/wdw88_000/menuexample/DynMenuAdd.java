...
public class DynMenuAdd extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        int groupId = 1;
        getMenuInflater().inflate(R.menu.dyn_menu_add, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == menuItemEditId) {
            Toast.makeText(DynMenuAdd.this,"you cliked on Edit", Toast.LENGTH_SHORT).show();
        }
        else if (id == menuItemFileId) {
            Toast.makeText(DynMenuAdd.this,"you cliked on File", Toast.LENGTH_SHORT).show();

        }
        else if (id ==menuItemViewId){
            Toast.makeText(DynMenuAdd.this,"you cliked on View", Toast.LENGTH_SHORT).show();
